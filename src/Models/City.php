...
class City extends \Vinelab\NeoEloquent\Eloquent\Model  {
  ...
  {
    return $this->belongsTo('Wetcat\Litterbox\Models\Country', 'HAS_CITY');
  }

  public function counties()
  {
    return $this->hasMany('Wetcat\Litterbox\Models\County', 'HAS_COUNTY');
  }
